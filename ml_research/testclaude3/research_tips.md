...
- Modern machine learning is heavily empirical. Running experiments on diverse experimental settings (for example, multiple domains, model families, or scales) can make results more convincing.
