...
if __name__ == '__main__':
    ...
    for N in [256]:
        ...
        for reg in [10.0, 50.0, 100.0, 500.0, 1000.0, 5000.0, 10000.0, 50000.0]:
            ...
            print(f"WFC + PR-LSHA (reg={reg}) - MNIST: {lsha_accs['mnist']*100:.2f}% | Fashion: {lsha_accs['fashion']*100:.2f}% | CIFAR: {lsha_accs['cifar']*100:.2f}% | Avg: {lsha_accs['avg']*100:.2f}%")
