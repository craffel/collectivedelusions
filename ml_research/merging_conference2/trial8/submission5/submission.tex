...
\midrule
Weight Averaging (WA) & None & 47.50 & 47.27 & 47.00 & 9.20 \\
 & QR-IPR (Ours) & 62.20 & 62.07 & 62.13 & 9.23 \\
 & SC-QR-IPR (Ours) & 62.20 & 62.07 & 62.13 & 9.23 \\
\midrule
Task Arithmetic ($\lambda=0.5$) & None & 9.83 & 9.83 & 9.83 & 9.83 \\
 & QR-IPR (Ours) & 62.20 & 62.07 & 62.13 & 9.23 \\
 & SC-QR-IPR (Ours) & 62.20 & 62.07 & 62.13 & 9.23 \\
\midrule
TIES-Merging & None & 40.73 & 40.97 & 40.97 & 11.93 \\
 & QR-IPR (Ours) & 32.83 & 10.33 & 9.90 & 9.23 \\
 & SC-QR-IPR (Ours) & 40.00 & 11.03 & 11.33 & 9.80 \\
\midrule
DARE-Merging & None & 30.40 & 30.40 & 30.30 & 9.67 \\
 & QR-IPR (Ours) & 9.83 & 9.83 & 9.83 & 9.83 \\
 & SC-QR-IPR (Ours) & 9.83 & 9.83 & 9.83 & 9.83 \\
\bottomrule
\end{tabular}
\end{scriptsize}
\end{center}
...
\midrule
Uncalibrated & 9.83 & 9.83 & 9.83 & 9.83 & 9.83 \\
U-IPR \cite{submission9} & 61.80 & 61.63 & 10.03 & 62.07 & 9.17 \\
HNS \cite{submission7} & 62.20 & 61.90 & 9.53 & 62.20 & 9.77 \\
\midrule
\textbf{QR-IPR (Ours)} & \textbf{62.20} & \textbf{62.07} & \textbf{9.93} & \textbf{62.13} & \textbf{9.23} \\
\bottomrule
\end{tabular}
\end{scriptsize}
\end{center}
...
HNS & 62.20 & 48.67 & 58.63 \\
\midrule
\textbf{QR-IPR (Ours)} & \textbf{62.20} & 48.40 & 58.57 \\
\bottomrule
\end{tabular}
\end{scriptsize}
\end{minipage}
