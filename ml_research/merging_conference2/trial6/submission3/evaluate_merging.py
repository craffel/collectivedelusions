...
# Increased batch size to 2048 for extremely fast testing
test_loaders = {
    "mnist": DataLoader(test_mnist, batch_size=2048, shuffle=False, num_workers=0),
    "fmnist": DataLoader(test_fmnist, batch_size=2048, shuffle=False, num_workers=0),
    "cifar10": DataLoader(test_cifar, batch_size=2048, shuffle=False, num_workers=0)
}
...
class MergedEvaluator:
    ...
    def evaluate(self, task_name, loader):
