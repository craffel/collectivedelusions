...
for method, lam in merge_configs:
    ...
    avg_acc = sum(accs_ts_bc) / 3
    print(f"{config_name:<20} | MNIST: {accs_ts_bc[0]:.4%} | FMNIST: {accs_ts_bc[1]:.4%} | CIFAR-10: {accs_ts_bc[2]:.4%} | Avg: {avg_acc:.4%}")
    results[config_name] = accs_ts_bc + [avg_acc]
