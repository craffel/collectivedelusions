...
def main():
    ...
    print(f"Using device: {device} for DARE-Merging evaluation")
    set_seed(42)
    ...
    # 4. Merge experts using DARE-Merging
    # We use drop rate p=0.2 and lam=0.4 as standard
    merged_model = dare_merge_models(progenitor, experts, lam=0.4, p=0.2)

    # 5. Run Calibration Algorithms
    print("\n--- Running Calibration Algorithms on DARE-Merged Model ---")
    ...
    print("\n--- Starting Comprehensive Evaluation for DARE-Merging ---")
    ...
    print("\n================== DARE-MERGING EVALUATION RESULTS SUMMARY ==================")
    ...
    with open("dare_results.json", "w") as f:
