...
print(f"Unnormalized Inactive - Local PFSR Accuracy: {correct_local / len(test_z) * 100.0:.2f}%")

# Evaluate Global PFSR
correct_global = 0
for b in range(len(test_z)):
...
print(f"Unnormalized Inactive - Global PFSR Accuracy: {correct_global / len(test_z) * 100.0:.2f}%")
