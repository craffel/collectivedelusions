...
\icmltitlerunning{Exclusive Parameter Merging}

\begin{document}

\twocolumn[
  \icmltitle{Exclusive Parameter Merging: Coherence-Preserved Multi-Task Model Fusion}
