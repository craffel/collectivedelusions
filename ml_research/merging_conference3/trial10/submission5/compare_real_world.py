...
def run_evaluation_across_seeds():
    ...
    # 5 independent seeds for statistical robustness
    ...
    # Tuned hyperparameters based on preliminary sweeps:
    # SABLE: temp=0.05
    # ChemMerge: temp=0.05, dt=1.5, k_decay=0.3
    # Momentum-Merge: temp=0.05, beta=0.80
    # UGR (Ours): temp=0.05, eta=0.10
    ...
    for seed in seeds:
        ...
        num_blocks = 16 # 800 samples total
        ...
        for method in methods:
            ...
            print(f"[{method:15s}] Acc: {mean_acc:.2%}, Jitter: {mean_jitter:.6f}")
            
    # Print final summary statistics
    print("\n" + "="*50)
    print("FINAL REAL-WORLD MULTI-TASK TEXT ENSEMBLING RESULTS")
    print("="*50)
