...
def main():
    ...
    train_size = 2000
    calib_size = 64
    test_size = 500 # FULL evaluation set
    ...
    print("\n--- Running Gated ChaosMerge (Task-Specific) on FULL evaluation set ---")
    ...
    for idx, name in enumerate(task_names):
        ...
        print(f"Gated ChaosMerge (Task-Specific) {name} Accuracy: {acc*100:.2f}%")
    print(f"Average: {np.mean(gated_spec_accs)*100:.2f}%")
