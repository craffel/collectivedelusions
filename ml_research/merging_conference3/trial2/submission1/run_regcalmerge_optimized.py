...
def get_cached_dataloader(dataset_name, preprocess, args):
    ...
    if cache_key not in _dataloader_cache:
        print(f"Loading and caching evaluation batches for {dataset_name}...")
        ...
        for i, batch in enumerate(dataloader):
            if i > 1: # Limit to 2 batches (256 images)
                break
        ...
        print(f"Successfully cached {len(batches)} evaluation batches for {dataset_name}.")
...
def get_cached_calib_batch(dataset_name, preprocess, args):
    ...
    if cache_key not in _calib_cache:
        print(f"Loading and caching calibration batch for {dataset_name}...")
        ...
        for batch in dataloader:
            ...
            break
        print(f"Successfully cached calibration batch for {dataset_name}.")
...
def run_experiment_pipeline():
    ...
    for seed in seeds:
        ...
        run_adam_optimization(model_adam, args.eval_datasets, args, beta=0.0, gamma=0.0, steps=10)
    ...
    for seed in seeds:
        ...
        run_es_optimization(model_es, args.eval_datasets, args, beta=0.0, gamma=0.0, steps=10)
    ...
    for seed in seeds:
        ...
        run_es_optimization(model_sm, args.eval_datasets, args, beta=0.0, gamma=0.0, steps=10)
    ...
    for seed in seeds:
        ...
        run_adam_optimization(model_sh_adam, args.eval_datasets, args, beta=0.0, gamma=0.0, steps=10)
    ...
    for seed in seeds:
        ...
        run_es_optimization(model_sh_es, args.eval_datasets, args, beta=0.0, gamma=0.0, steps=10)
    ...
    for b in beta_sweep:
        for g in gamma_sweep:
            ...
            for seed in seeds[:1]:
                ...
                run_adam_optimization(model_grid, args.eval_datasets, args, beta=b, gamma=g, use_ccn=True, use_snew=True, steps=8)
