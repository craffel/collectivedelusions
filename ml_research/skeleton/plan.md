...
- **Constraints:** Maximum 8 pages for the main paper, plus unlimited pages for references and appendix. Follow the formatting instructions in `template/example_paper.pdf`.
...
- **Refinement Strategy:**
  ...
  - **Reviewing:** When considering areas for improvement, pay attention to the reviewing criteria in `reviewing_criteria.md`.
