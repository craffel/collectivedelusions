...
Static Merging & 76.50\% & 53.90\% & 75.00\% & 70.21\% & \textbf{68.90\%} \\
AdaMerging & 64.19\% & 41.90\% & 64.38\% & 60.98\% & \textbf{57.86\%} \\
LFWA & 44.04\% & 38.83\% & 40.81\% & 40.92\% & \textbf{41.15\%} \\
PC-Merge + OPR & 90.79\% & 45.46\% & 90.10\% & 81.12\% & \textbf{76.87\%} \\
\textbf{IGGS-Merge (Ours)} & \textbf{92.83\%} & \textbf{59.08\%} & \textbf{92.62\%} & \textbf{86.19\%} & \textbf{82.68\%} \\
\midrule
\textbf{Sequential Stream} & & & & & \\
Static Merging & 76.50\% & 53.90\% & 75.00\% & 70.21\% & \textbf{68.90\%} \\
AdaMerging & 41.90\% & 38.00\% & 41.40\% & 41.12\% & \textbf{40.60\%} \\
LFWA & 76.35\% & 38.79\% & 57.52\% & 51.31\% & \textbf{55.99\%} \\
PC-Merge + OPR & 90.79\% & 45.46\% & 89.81\% & 81.15\% & \textbf{76.80\%} \\
\textbf{IGGS-Merge (Ours)} & \textbf{92.83\%} & \textbf{59.08\%} & \textbf{92.62\%} & \textbf{86.19\%} & \textbf{82.68\%} \\
\bottomrule
\end{tabular}
\end{footnotesize}
...
\midrule
\textbf{Alternating Stream} & & & \\
Full IGGS-Merge & 59.08\% & 86.19\% & 72.64\% \\
No OPR & 59.08\% & 86.19\% & 72.64\% \\
Euclidean Projection & 58.75\% & 86.54\% & 72.65\% \\
No Projection & 58.75\% & 86.62\% & 72.69\% \\
No Preconditioning & 45.42\% & 81.62\% & 63.52\% \\
\midrule
\textbf{Sequential Stream} & & & \\
Full IGGS-Merge & 59.08\% & 86.19\% & 72.64\% \\
No OPR & 59.08\% & 86.19\% & 72.64\% \\
Euclidean Projection & 58.75\% & 86.54\% & 72.65\% \\
No Projection & 58.75\% & 86.62\% & 72.69\% \\
No Preconditioning & 45.42\% & 81.65\% & 63.53\% \\
\bottomrule
\end{tabular}
\end{footnotesize}
\end{center}
...
\midrule
\textbf{Alternating Stream} & & & \\
$\alpha = 0.0$ & 45.46\% & 81.12\% & 63.29\% \\
$\alpha = 0.25$ & 56.52\% & 87.06\% & 71.79\% \\
$\alpha = 0.50$ (Ours) & 59.08\% & 86.19\% & 72.64\% \\
$\alpha = 0.75$ & 58.85\% & 86.23\% & 72.54\% \\
$\alpha = 1.00$ & Unstable & Unstable & Unstable \\
\midrule
\textbf{Sequential Stream} & & & \\
$\alpha = 0.0$ & 45.46\% & 81.15\% & 63.30\% \\
$\alpha = 0.25$ & 56.52\% & 87.06\% & 71.79\% \\
$\alpha = 0.50$ (Ours) & 59.08\% & 86.19\% & 72.64\% \\
$\alpha = 0.75$ & 58.85\% & 86.23\% & 72.54\% \\
$\alpha = 1.00$ & Unstable & Unstable & Unstable \\
