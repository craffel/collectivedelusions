...
We evaluate our proposed framework on the multi-task vision benchmark established in prior work \cite{sata2026, s2cmerge2026}.
...
\midrule
STATIC   & 78.23\% & 47.14\% & 56.31\% & \textbf{17.57\%} & 49.81\% \\
STANDARD & 42.97\% & 16.92\% & 22.80\% & 11.26\% & 23.49\% \\
S2C      & 72.82\% & 40.41\% & 56.03\% & 16.57\% & 46.46\% \\
EWC      & 29.07\% & 14.70\% & 15.14\% & 10.76\% & 17.42\% \\
DURGP    & 47.09\% & 17.26\% & 23.96\% & 11.16\% & 24.87\% \\
\textbf{TD-ATMM (Ours)} & \textbf{86.22\%} & \textbf{47.19\%} & \textbf{61.04\%} & 17.33\% & \textbf{52.95\%} \\
\midrule
\multicolumn{6}{c}{\textbf{Alternating Stream}} \\
\midrule
STATIC   & 78.23\% & 47.10\% & 56.31\% & \textbf{17.57\%} & 49.80\% \\
STANDARD & 49.81\% & 15.99\% & 23.16\% & 12.17\% & 25.28\% \\
S2C      & 75.98\% & 42.47\% & 57.96\% & 14.94\% & 47.84\% \\
EWC      & 30.29\% & 13.31\% & 15.01\% & 12.55\% & 17.79\% \\
DURGP    & 51.42\% & 16.02\% & 24.32\% & 12.14\% & 25.97\% \\
\textbf{TD-ATMM (Ours)} & \textbf{86.17\%} & \textbf{47.82\%} & \textbf{60.98\%} & 17.32\% & \textbf{53.07\%} \\
\bottomrule
\end{tabular}
\end{sc}
\end{small}
...
Our proposed TD-ATMM achieves outstanding performance, outperforming the next-best baseline (STATIC) by \textbf{+3.14\%} on sequential and \textbf{+3.27\%} on alternating streams. It outperforms S2C-Merge by \textbf{+6.49\%} on sequential and \textbf{+5.23\%} on alternating streams.
