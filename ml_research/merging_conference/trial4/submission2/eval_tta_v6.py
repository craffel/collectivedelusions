...
def evaluate_tta(method_name, experts, base_params, task_vectors, test_loaders, fisher_dict=None, corruption_type='clean', num_cycles=100, ewc_lambda=1000.0, lr_head=1e-4, use_softmax=True):
    torch.manual_seed(42)
    ...
    if method_name == 'static_merged':
        ...
        # Ours: Task-Adaptive coefficients
    ...
    for cycle in range(num_cycles):
        for task_idx, task_name in enumerate(task_names):
            ...
            # Predict active task for Ours (uewc_merge) in a teacher-free way
            if method_name == 'uewc_merge':
                with torch.no_grad():
            ...
            if method_name != 'static_merged':
                ...
                use_softmax_method = use_softmax if method_name in ['uewc_merge', 'static_merged', 'ewc_tta'] else False
