...
def main():
    ...
    for name, loader in [('MNIST', mnist_test_loader), ('KMNIST', kmnist_test_loader), ('F-MNIST', fmnist_test_loader)]:
        ...
        # Clean
        c_clean = compute_cohesion(batch_X)
        # Noise
        c_noise = compute_cohesion(apply_noise(batch_X))
        # Contrast
        c_contrast = compute_cohesion(apply_contrast(batch_X))
