...
def main():
    ...
    lr_candidates = [100.0, 150.0, 200.0]
    alphas = [0.0, 10.0, 50.0]
    betas = [100.0, 500.0, 1000.0]
    rhos = [0.02, 0.05]
    dampings = [0.05, 0.1]
                ...
                for rho in rhos:
                    for db in dampings:
                        ...
                        if overall_acc > best_acc:
                            ...
                            print(f"NEW BEST: lr={lr:<5} | alpha={alpha:<5} | beta={beta:<6} | rho={rho:<5} | db={db:<5} -> Acc: {overall_acc*100:.4f}% (P1: {phase_accs[0]*100:.1f}%, P2: {phase_accs[1]*100:.1f}%, P3: {phase_accs[2]*100:.1f}%, P4: {phase_accs[3]*100:.1f}%, P5: {phase_accs[4]*100:.1f}%)")
