...
def main():
    ...
    lr_candidates = [100.0, 150.0, 200.0, 250.0, 300.0]
    alphas = [0.0, 10.0, 50.0, 100.0, 200.0]
    betas = [100.0, 300.0, 500.0, 1000.0, 2000.0]
    rhos = [0.02, 0.05, 0.08]
    ...
    print("Running wider grid search...")
                ...
                for rho in rhos:
                    for db in dampings:
                        ...
                        if overall_acc > best_acc:
                            ...
                            print(f"NEW BEST: lr={lr:<5} | alpha={alpha:<5} | beta={beta:<6} | rho={rho:<5} | db={db:<5} -> Acc: {overall_acc*100:.4f}%")
                            
    print("\nWider sweep complete.")
