"""Sweep Model Breadcrumbs baseline on the 8-task benchmark (fast variant: preloaded loaders)."""
import argparse
import json
import os
import sys
...
def main():
    ...
    ap.add_argument("--out", default="/fsx/craffel/collectivedelusions/ml_research/testclaude/results/breadcrumbs.json")
    ...
    device = args.device
    print(f"[init] loading {len(tasks)} tasks", flush=True)
